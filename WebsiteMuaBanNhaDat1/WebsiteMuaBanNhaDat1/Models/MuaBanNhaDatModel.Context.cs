...
namespace WebsiteMuaBanNhaDat1.Models
{
    ...
    public partial class MuaBanNhaDatEntities : DbContext
    {
        public MuaBanNhaDatEntities()
            : base("name=MuaBanNhaDatEntities")
        {
        }
        ...
        public virtual DbSet<XacNhan> XacNhan { get; set; }
